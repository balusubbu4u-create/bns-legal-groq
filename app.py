...
st.write("కేసు వివరాలు నమోదు చేసి విశ్లేషించండి (Powered by Groq).")
...
1. వాస్తవాల ఆధారితం: అందించిన ఫిర్యాదులోని వాస్తవాల (facts) ఆధారంగా మాత్రమే ఖచ్చితమైన సెక్షన్లు పేర్కొనాలి.
    ...
    if not case_text:
        ...
        with st.spinner("Groq ద్వారా వేగంగా చట్టాలను పరిశీలిస్తోంది..."):
            try:
                ...
                # Groq క్లయింట్ ప్రారంభం
                client = Groq(api_key=api_key)

                # llama-3.3-70b అత్యంత శక్తివంతమైన మరియు వేగవంతమైన ఫ్రీ మోడల్
