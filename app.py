...
# Sidebar: Key Input Fallback & Dynamic Model Fetching
...
# Automatically fetch available models from Groq for this API Key
...
selected_model = st.sidebar.selectbox(
    ...
    index=0,
    help="మీ Groq ఖాతాలో ఆమోదించబడిన మోడల్స్ మాత్రమే ఇక్కడ కనిపిస్తాయి."
)
...
# Ultra-Reliable JSON extractor for reasoning & chat models
def clean_and_parse_json(text):
    # Remove thought/reasoning tags if generated by gpt-oss
...
1. Strict Ingredient Matching:
   ...
   - Bodily Harm/Assault/Threats: Map to relevant BNS sections (Sec 115, Sec 351, Sec 352, etc.).
