...
def extract_text_from_pdf(uploaded_file):
    # First try normal text extraction using pypdf
    ...
    # If text is too short, it might be a scanned PDF or image-based PDF
...
if analyze_btn:
    ...
    if not complaint_content.strip() and not image_contents:
        ...
        with st.spinner("법 Legal analysis జరుగుతోంది... దయచేసి వేచి ఉండండి."):
            try:
                if image_contents:
                    # Vision model processing for scanned PDFs/images
